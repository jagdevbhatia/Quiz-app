...
public class Quiz extends JFrame implements ActionListener{
   ...
   public static int score=0;
    ...
    Quiz(String username){
        ...
        next.setBounds(1100,500,200,35);
        ...
        lifeline.setBounds(1100,570,200,35);
        ...
        submit.setBounds(1100,640,200,35);
    ...
    public void paint(Graphics g){
       ...
       g.setFont(new Font("tahuma",Font.BOLD,22));
